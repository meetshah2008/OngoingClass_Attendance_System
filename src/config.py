import os
# gt_folder_path = f"../data/gt"
# gt_folder_path = f"../data/few_gt"
# gt_folder_path = f"../data/GroundTruth_cluster"
# gt_folder_path = f"../data/GroundTruth_cluster_renamed"
# gt_folder_path = f"../data/GroundTruth"
# gt_folder_path = f"../data/given_gt"
